...
<body>
    ...
    <div class="container row my-4 mx-4 text-center" id="dynamic">
        ...
        <?php 
            ...
            $table="SELECT * FROM `geekhaven` WHERE category='Dance'";
    ...
    <!-- POSTS ABOUT SOCIETY -->
    <h1 class="text-center">Genetic-X Post!</h1>
    ...
    if(isset($_POST['postAdd'])){
        ...
        $posts=$_POST['post'];
        $putQuery="INSERT INTO `posts` (`post`) VALUES ('$posts')";
        $results=mysqli_query($con,$putQuery);

    }
   
    $tablePost= "SELECT * FROM `posts`";
