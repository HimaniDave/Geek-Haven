...
<body>
    ...
    <div class="container row my-4 mx-4 text-center" id="dynamic">
        ...
        <?php 
                ...
                $table="SELECT * FROM `geekhaven` WHERE category='Music'";
    ...
    if(isset($_POST['postAdd'])){
        ...
        $posts=$_POST['post'];
        $putQuery="INSERT INTO `music` (`post`) VALUES ('$posts')";
        $results=mysqli_query($con,$putQuery);

    }
   
    $tablePost= "SELECT * FROM `music`";
